        ...
        <div className="mb-8 flex items-center justify-between gap-4 rounded-2xl border-2 border-slate-300 bg-white px-6 py-3 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex min-w-[130px] items-center justify-center rounded-lg border border-slate-400 bg-white px-4 py-0.5 text-xs font-semibold tracking-wider text-slate-800 transition hover:border-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-40"
            >
              {anyWorking ? (
            ...
            <button
              ...
              className="inline-flex min-w-[130px] items-center justify-center rounded-lg border border-amber-400 bg-white px-4 py-0.5 text-xs font-semibold tracking-wider text-amber-700 transition hover:border-amber-600 hover:bg-amber-50 disabled:cursor-not-allowed disabled:opacity-40"
            >
              <span className="inline-flex items-center">
